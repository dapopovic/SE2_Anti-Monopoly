 ...
 */
class JsonDataUtilityTest {

    @Test
    void createStringFromJsonMessageShouldReturnValidJson() {
        Map<String, String> data = new HashMap<>();
        data.put("key", "value");
        String json = JsonDataUtility.createJsonMessage(Commands.NEW_USER, data);
    ...
    void createStringFromJsonMessageWithJsonDataDTOShouldReturnValidJson() {
        ...
        String json = JsonDataUtility.createJsonMessage(jsonDataDTO);
    ...
    void createStringFromJsonMessageUsingAnObjectShouldReturnValidValue() {
        ...
        String json = JsonDataUtility.createJsonMessage(users);
    ...
    void createStringFromJsonMessageUsingAnObjectShouldReturnNull() {
        ...
        String json = JsonDataUtility.createJsonMessage(object);
        assertNull(json);
    }
