...
public class MessagingUtility {
    ...
    private static MessagingUtility instance;

    private MessagingUtility() {
    }

    public static synchronized MessagingUtility getInstance() {
        if (instance == null) {
            instance = new MessagingUtility();
        }
        return instance;
    }
    ...
    public static class MessageContainer {
        ...
        private MessageContainer(JsonDataDTO jsonDataDTO) {
            ...
            this.message = JsonDataUtility.createJsonMessage(jsonDataDTO);
        }
