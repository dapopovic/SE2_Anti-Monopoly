...
public class GameBoardActivity extends AppCompatActivity {
    ...
    private void processIntent() {
        ...
        currentUser = JsonDataUtility.parseJsonMessage(intent.getStringExtra("currentUser"), User.class);
        if (currentUser != null) {
    ...
    public void onHeartBeatEvent(HeartBeatEvent event) {
        ...
        String jsonMessage = JsonDataUtility.createJsonMessage(jsonData);
    ...
    public void sendDice(int dice1, int dice2, boolean cheat) {
        ...
        String jsonDataString = JsonDataUtility.createJsonMessage(jsonData);
